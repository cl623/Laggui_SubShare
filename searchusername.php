<?php 
    ...
    if($success && ($statement->rowCount() > 0)){
        ...
        $response = "<table><tr><td><span>".$result[0]['name']."</span></td><td><span>".$result[0]['username']."</span></td><td><span class='material-icons' onclick='addFriend(".$result[0]['username'].")'>add</span></td></tr></table>";
        echo $response;
        exit();
    }
    else{
